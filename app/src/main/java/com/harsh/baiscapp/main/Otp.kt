...
@Composable
fun OtpPage(navController: NavController,name:String, phoneNumber: String, password: String) {
    ...
    Column(
        ...
        Button(
            onClick = {
                if (otp.value == "1234") {
                    val route = "$Routes.DASHBOARD?name=$name&phoneNumber=$phoneNumber&password=$password"
